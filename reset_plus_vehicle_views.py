"""
Script para resetear las vistas de vehículos PLUS
...
def reset_plus_vehicle_views():
    """Elimina todas las vistas de vehículos PLUS"""
    
    print("="*60)
    print("RESETEAR VISTAS DE VEHÍCULOS PLUS")
    print("="*60)
